...
namespace Meritocious.Web.Migrations
{
    ...
    [Migration("20250408233555_ExternalFork")]
    partial class ExternalFork
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Meritocious.Core.Entities.ExternalForkSource", b =>
                {
                    b.Property<string>("UlidId")
                        .HasMaxLength(26)
                        .IsUnicode(false)
                    ...
                    b.ToTable("ExternalForkSources", (string)null);
                });
            ...
            modelBuilder.Entity("Meritocious.Core.Entities.ForkRequest", b =>
                {
                    b.Property<string>("UlidId")
                        .HasMaxLength(26)
                        .IsUnicode(false)
                    ...
                    b.Property<string>("ExternalForkSourceId")
                        .IsRequired()
                        .HasMaxLength(26)
                        .IsUnicode(false)
                        .HasColumnType("varchar(26)");

                    b.Property<string>("FulfilledByPostId")
                        .HasMaxLength(26)
                        .IsUnicode(false)
                        .HasColumnType("varchar(26)");
                    ...
                    b.HasIndex("ExternalForkSourceId");

                    b.HasIndex("FulfilledByPostId");

                    b.HasIndex("Status");

                    b.HasIndex("SubmitterId");

                    b.HasIndex("Status", "ClaimedById");

                    b.HasIndex("Status", "ExternalForkSourceId");

                    b.ToTable("ForkRequests", (string)null);
                });

            modelBuilder.Entity("Meritocious.Core.Entities.ForkType", b =>
                {
                    b.Property<string>("UlidId")
                        .HasMaxLength(26)
                        .IsUnicode(false)
                    ...
                    b.ToTable("ForkTypes", (string)null);
                });
            ...
            modelBuilder.Entity("Meritocious.Core.Entities.Post", b =>
                {
                    ...
                    b.Property<string>("ExternalForkContext")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("ExternalForkQuote")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.HasIndex("ExternalForkSourceId", "CreatedAt");

                    b.HasIndex("ForkTypeId", "CreatedAt");
            ...
            modelBuilder.Entity("Meritocious.Core.Entities.ForkRequest", b =>
                {
                    b.HasOne("Meritocious.Core.Entities.User", "ClaimedBy")
                        .WithMany()
                        .HasForeignKey("ClaimedById")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Meritocious.Core.Entities.ExternalForkSource", "ExternalForkSource")
                        .WithMany("Requests")
                        .HasForeignKey("ExternalForkSourceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Meritocious.Core.Entities.Post", "FulfilledByPost")
                        .WithMany()
                        .HasForeignKey("FulfilledByPostId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Meritocious.Core.Entities.User", "Submitter")
                        .WithMany()
                    ...
                    b.Navigation("ExternalForkSource");

                    b.Navigation("FulfilledByPost");
            ...
            modelBuilder.Entity("Meritocious.Core.Entities.Post", b =>
                {
                    ...
                    b.HasOne("Meritocious.Core.Entities.ForkType", "ForkType")
                        .WithMany("Posts")
